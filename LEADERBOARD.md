...
| 19 | Granite Embedding 311M Multilingual R2 | bnb4 | wasm | 0.6215 | 0.7104 | — | 0.9815 | 0.9630 | 0.8889 | — | 0.5713 | 0.4284 | 1180.7 | 1m 55s | 6285.5 | 768 |
| 20 | Granite Embedding 311M Multilingual R2 | q4 | wasm | 0.6215 | 0.7104 | — | 0.9815 | 0.9630 | 0.8889 | — | 0.5713 | 0.4284 | 1175.8 | 1m 8s | 6342.1 | 768 |
| 21 | Qwen3 Embedding 0.6B | bnb4 | wasm | 0.6103 | 0.7336 | — | 0.9815 | 0.9630 | 0.8704 | — | 0.7370 | 0.6625 | 5007.7 | 4m 44s | 6382.2 | 1024 |
| 22 | Granite Embedding 311M Multilingual R2 | uint8 | wasm | 0.6055 | 0.6586 | — | 0.9815 | 0.9630 | 0.9259 | — | 0.5347 | 0.3758 | 481.5 | 38s | 5209.6 | 768 |
| 23 | Granite Embedding 311M Multilingual R2 | int8 | wasm | 0.6042 | 0.6557 | — | 0.9815 | 0.9815 | 0.9259 | — | 0.5341 | 0.3757 | 483.3 | 28s | 5729.4 | 768 |
| 24 | Granite Embedding 311M Multilingual R2 | quantized (q8) | wasm | 0.6042 | 0.6557 | — | 0.9815 | 0.9815 | 0.9259 | — | 0.5341 | 0.3757 | 484.6 | 39s | 5418.1 | 768 |
| 25 | Qwen3 Embedding 0.6B | int8 | wasm | 0.5962 | 0.7195 | — | 0.9815 | 0.9630 | 0.8519 | — | 0.7690 | 0.7226 | 2261.4 | 2m 5s | 5750.8 | 1024 |
| 26 | Qwen3 Embedding 0.6B | quantized (q8) | wasm | 0.5933 | 0.7138 | — | 0.9815 | 0.9630 | 0.8148 | — | 0.7700 | 0.7255 | 2275.3 | 2m 21s | 6206.5 | 1024 |
| 27 | Qwen3 Embedding 0.6B | uint8 | wasm | 0.5933 | 0.7138 | — | 0.9815 | 0.9630 | 0.8148 | — | 0.7700 | 0.7255 | 2271.1 | 2m 24s | 6285.3 | 1024 |
| 28 | Snowflake Arctic Embed L v2.0 | uint8 | wasm | 0.5466 | 0.5696 | — | 0.9815 | 0.9444 | 0.7963 | — | 0.4376 | 0.3566 | 1079.5 | 1m 10s | 9695.3 | 1024 |
| 29 | Snowflake Arctic Embed L v2.0 | int8 | wasm | 0.5460 | 0.5656 | — | 0.9815 | 0.9630 | 0.7963 | — | 0.4389 | 0.3545 | 1081.3 | 1m 0s | 11836.0 | 1024 |
| 30 | Snowflake Arctic Embed L v2.0 | quantized (q8) | wasm | 0.5460 | 0.5656 | — | 0.9815 | 0.9630 | 0.7963 | — | 0.4389 | 0.3545 | 1078.6 | 1m 7s | 10311.4 | 1024 |
| 31 | Snowflake Arctic Embed M v2.0 | uint8 | wasm | 0.5441 | 0.5504 | — | 0.9815 | 0.9815 | 0.7778 | — | 0.5196 | 0.4212 | 413.5 | 28s | 9693.3 | 768 |
| 32 | Snowflake Arctic Embed M v2.0 | int8 | wasm | 0.5413 | 0.5434 | — | 0.9815 | 0.9630 | 0.7963 | — | 0.5158 | 0.4175 | 413.5 | 24s | 9724.2 | 768 |
| 33 | Snowflake Arctic Embed M v2.0 | quantized (q8) | wasm | 0.5413 | 0.5434 | — | 0.9815 | 0.9630 | 0.7963 | — | 0.5158 | 0.4175 | 411.4 | 27s | 9723.6 | 768 |
...
| Granite Embedding 311M Multilingual R2 | bnb4 | ok | wasm | 768 | 51.4s | 1m 55s | 1180.7 | 2032.5 | 6285.5 | 0.6215 | 0.7104 | — | 0.9815 | 0.9630 | 0.8889 | 1.0000 | 0.5713 | 0.4284 | — |
| Granite Embedding 311M Multilingual R2 | int8 | ok | wasm | 768 | 2.1s | 28s | 483.3 | 906.9 | 5729.4 | 0.6042 | 0.6557 | — | 0.9815 | 0.9815 | 0.9259 | 1.0000 | 0.5341 | 0.3757 | — |
| Granite Embedding 311M Multilingual R2 | q4 | ok | wasm | 768 | 4.8s | 1m 8s | 1175.8 | 1996.5 | 6342.1 | 0.6215 | 0.7104 | — | 0.9815 | 0.9630 | 0.8889 | 1.0000 | 0.5713 | 0.4284 | — |
| Granite Embedding 311M Multilingual R2 | q4f16 | error | — | — | 12.0s | 11s | — | — | 6332.1 | — | — | — | — | — | — | — | — | — | FP16 tensor type mismatch |
| Granite Embedding 311M Multilingual R2 | quantized (q8) | ok | wasm | 768 | 12.8s | 39s | 484.6 | 929.1 | 5418.1 | 0.6042 | 0.6557 | — | 0.9815 | 0.9815 | 0.9259 | 1.0000 | 0.5341 | 0.3757 | — |
| Granite Embedding 311M Multilingual R2 | uint8 | ok | wasm | 768 | 12.3s | 38s | 481.5 | 910.8 | 5209.6 | 0.6055 | 0.6586 | — | 0.9815 | 0.9630 | 0.9259 | 1.0000 | 0.5347 | 0.3758 | — |
...
| Snowflake Arctic Embed L v2.0 | int8 | ok | wasm | 1024 | 2.3s | 1m 0s | 1081.3 | 1932.5 | 11836.0 | 0.5460 | 0.5656 | — | 0.9815 | 0.9630 | 0.7963 | 1.0000 | 0.4389 | 0.3545 | — |
...
| Snowflake Arctic Embed L v2.0 | quantized (q8) | ok | wasm | 1024 | 9.4s | 1m 7s | 1078.6 | 1945.3 | 10311.4 | 0.5460 | 0.5656 | — | 0.9815 | 0.9630 | 0.7963 | 1.0000 | 0.4389 | 0.3545 | — |
| Snowflake Arctic Embed L v2.0 | uint8 | ok | wasm | 1024 | 11.7s | 1m 10s | 1079.5 | 1924.2 | 9695.3 | 0.5466 | 0.5696 | — | 0.9815 | 0.9444 | 0.7963 | 1.0000 | 0.4376 | 0.3566 | — |
| Snowflake Arctic Embed M v2.0 | bnb4 | error | — | — | 14.2s | 14s | — | — | 10477.1 | — | — | — | — | — | — | — | — | — | OOM (std::bad_alloc) |
| Snowflake Arctic Embed M v2.0 | int8 | ok | wasm | 768 | 1.5s | 24s | 413.5 | 744.7 | 9724.2 | 0.5413 | 0.5434 | — | 0.9815 | 0.9630 | 0.7963 | 1.0000 | 0.5158 | 0.4175 | — |
...
| Snowflake Arctic Embed M v2.0 | quantized (q8) | ok | wasm | 768 | 4.7s | 27s | 411.4 | 737.5 | 9723.6 | 0.5413 | 0.5434 | — | 0.9815 | 0.9630 | 0.7963 | 1.0000 | 0.5158 | 0.4175 | — |
| Snowflake Arctic Embed M v2.0 | uint8 | ok | wasm | 768 | 6.0s | 28s | 413.5 | 747.8 | 9693.3 | 0.5441 | 0.5504 | — | 0.9815 | 0.9815 | 0.7778 | 1.0000 | 0.5196 | 0.4212 | — |
...
| Granite Embedding 311M Multilingual R2 | bnb4 | 0.6215 | 0.7104 | — | 0.9815 | 0.9630 | 1180.7 | 6285.5 | wasm |
| Jina Embeddings v5 Omni Nano (text) | — | — | — | — | — | — | — | — | all failed |
| Qwen3 Embedding 0.6B | q4 | 0.6232 | 0.7679 | — | 0.9815 | 0.9444 | 5518.5 | 6436.6 | wasm |
| Snowflake Arctic Embed L v2.0 | uint8 | 0.5466 | 0.5696 | — | 0.9815 | 0.9444 | 1079.5 | 9695.3 | wasm |
| Snowflake Arctic Embed M v2.0 | uint8 | 0.5441 | 0.5504 | — | 0.9815 | 0.9815 | 413.5 | 9693.3 | wasm |
